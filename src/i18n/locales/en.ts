...
const en: Translations = {
  ...
  list: {
    ...
    addItem: "Add",
    slashMenuAriaLabel: "Formatting options",
    slashBold: "Bold",
    slashItalic: "Italic",
    slashCode: "Code",
    slashLink: "Link",
    slashPlace: "Place",
    slashTag: "Tag",
    slashBoldPlaceholder: "text",
    slashLinkLabelPlaceholder: "text",
    slashLinkUrlPlaceholder: "url",
  ...
  notifications: {
    ...
    itemCommented: "{{name}} commented on an item in «{{list}}»",
    listForked: "{{name}} made their own copy of «{{list}}»",
  ...
  collections: {
    title: "Collections",
    nav: "Collections",
    subtitle: "Group lists into themed collections.",
    explore: "Explore",
    mine: "Your collections",
    create: "Create",
    createPlaceholder: "New collection name…",
    listCount_one: "{{count}} list",
    listCount_other: "{{count}} lists",
    private: "Private",
    empty: "No public collections yet.",
    noLists: "No lists in this collection yet.",
    removeList: "Remove from collection",
