export const es = {
  ...
  list: {
    ...
    emptySubtitle: "Añade el primer ítem para empezar.",
    emptyAction: "Añadir ítem",
  ...
  settings: {
    ...
    deleteList: "Eliminar lista",
    couldNotSave: "No se pudo guardar",
    couldNotFork: "No se pudo bifurcar",
  ...
  collections: {
    title: "Colecciones",
    subtitle: "Agrupa listas en colecciones temáticas.",
    mine: "Tus colecciones",
    create: "Crear",
    createPlaceholder: "Nombre de la colección…",
    listCount_one: "{{count}} lista",
    listCount_other: "{{count}} listas",
    empty: "Aún no hay colecciones públicas.",
    noLists: "Aún no hay listas en esta colección.",
    delete: "Eliminar",
  ...
  notifications: {
    ...
    item_liked: "le gustó un ítem de",
    item_commented: "comentó un ítem de",
    list_forked: "hizo su propia copia de",
    weekly_recap: "Tu semana: {{count}} interacciones nuevas",
  },
  users: {
    title: "Usuarios",
