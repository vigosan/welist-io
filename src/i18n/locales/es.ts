const es = {
  ...
  list: {
    ...
    addItem: "Añadir",
    slashMenuAriaLabel: "Opciones de formato",
    slashBold: "Negrita",
    slashItalic: "Cursiva",
    slashCode: "Código",
    slashLink: "Enlace",
    slashPlace: "Lugar",
    slashTag: "Etiqueta",
    slashBoldPlaceholder: "texto",
    slashLinkLabelPlaceholder: "texto",
  ...
  myLists: {
    ...
    roleCreated: "Creadas",
    roleParticipating: "Participando",
    public: "Pública",
    collaborative: "Colaborativa",
  ...
  notifications: {
    ...
    itemCommented: "{{name}} ha comentado un ítem de «{{list}}»",
    listForked: "{{name}} ha hecho su propia copia de «{{list}}»",
  ...
  feed: {
    title: "Actividad",
    nav: "Actividad",
    subtitle: "Lo que están haciendo las personas que sigues.",
  ...
  collections: {
    ...
    removeList: "Quitar de la colección",
