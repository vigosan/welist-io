export const en = {
  ...
  notifications: {
    ...
    item_liked: "liked an item in",
    item_commented: "commented on an item in",
    list_forked: "made their own copy of",
    weekly_recap: "Your week: {{count}} new interactions",
  },
  users: {
    title: "Users",
    search: "Search users",
